...
@WebServlet(name = "CrearTematicaAdmin", urlPatterns = {"/panel-administrador/tematicas/agregar"})
public class CrearTematicaAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/crear_tematica_admin.jsp").forward(req, resp);
    }
