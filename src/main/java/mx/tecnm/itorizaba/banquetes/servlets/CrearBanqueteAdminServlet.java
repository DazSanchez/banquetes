...
@WebServlet(name = "CrearBanqueteAdminServlet", urlPatterns = {"/panel-administrador/banquetes/agregar"})
public class CrearBanqueteAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/crear_banquete_admin.jsp").forward(req, resp);
    }
