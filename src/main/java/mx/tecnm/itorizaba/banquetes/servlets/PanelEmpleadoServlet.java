...
@WebServlet(name = "PanelEmpleadoServlet", urlPatterns = {"/panel-empleado"})
public class PanelEmpleadoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (tipoUsuario == null) {
            ...
            return;
        } else if(!((String) tipoUsuario).equals("empleado")) {
        ...
        request.getRequestDispatcher("/panel_empleado.jsp").forward(request, response);
    }
}
