    ...
    <jsp:body>
        <div class="d-flex justify-content-center align-items-center min-vh-100 bg-light row">
            <div class="card border-0 shadow-sm col-md-6">
                <div class="card-body">
                    <h5 class="card-title">Editar menú</h5>
                    ...
                    <form action="${pageContext.request.contextPath}/panel-administrador/menus/editar" method="POST" class="mt-3 row">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="nombreInput" name="nombre" required="required" value="${menu.nombre}">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="entradaInput" name="platillos[0]" required="required" value="${menu.platillos[0].nombre}">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="platoFuerteInput" name="platillos[1]" required="required" value="${menu.platillos[1].nombre}">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="postreInput" name="platillos[2]" required="required" value="${menu.platillos[2].nombre}">
