    ...
    <jsp:attribute name="scriptsExternos">
        <c:if test="${requestScope.tieneExito == true}">
            <script>
                Swal.fire({
                    icon: 'success',
                    titleText: "Temática creada",
                    text: "Se ha creado la nueva temática.",
                    timer: 4000,
    ...
    <jsp:body>
        <div class="d-flex justify-content-center align-items-center min-vh-100 bg-light row">
            <div class="card border-0 shadow-sm col-md-6">
                <div class="card-body">
                    <h5 class="card-title">Crear temática</h5>
                    ...
                    <form action="${pageContext.request.contextPath}/panel-administrador/tematicas/agregar" method="POST" class="mt-3 row">
                        <div class="col-md-12">
